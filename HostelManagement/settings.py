...
SECRET_KEY = 'django-insecure-5+j_(i7yo2_6p$4e%#_60bg&4p4z7o^f=%@(ey9_vew3hgk-zf'
...
JAZZMIN_SETTINGS = {
    ...
    "site_header": "🏠 Gajjar Bhavan",
    "site_brand": "Hostel Management",
    ...
    "usermenu_links": [
        {"name": "Support", "url": "https://svnit.ac.in", "new_window": True},
    ],
}
